        ...
        app.dbconn.collection('goods_datas').where({
          ...
          success: function (res) {
            for (var t = 0; t < cart.length; t++) {
              if (res.data[0].goods_no == cart[t].goods_no) {
                cart[t].goods_name = res.data[0].goods_name
                cart[t].price = res.data[0].goods_price
                cart[t].goods_limit_num = res.data[0].goods_limit_num
